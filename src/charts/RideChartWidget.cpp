...
static QString labelForMetric(Metric metric)
{
    switch (metric)
    {
...
static QString labelForColorMetric(ColorMetric metric)
{
    switch (metric)
    {
...
static Metric metricFromColorMetric(ColorMetric metric)
{
    switch (metric)
    {
...
static double valueForMetric(const RideRecord& record, Metric metric)
{
    switch (metric)
    {
...
static bool isValidSample(const RideRecord& record, Metric metric)
{
    switch (metric)
    {
...
static int autoSmoothingSecondsForSpan(double spanMinutes)
{
...
static QColor colorForMetricValue(ColorMetric metric,
...
static bool hasColorMetricValue(ColorMetric metric, const RideRecord& record)
{
    switch (metric)
    {
